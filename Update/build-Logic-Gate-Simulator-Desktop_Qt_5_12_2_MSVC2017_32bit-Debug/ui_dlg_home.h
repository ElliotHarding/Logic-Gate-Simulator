...
public:
    ...
    void setupUi(QMainWindow *DLG_Home)
    {
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/Resources/Resources/gate-or.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/Resources/Resources/gate-not.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/Resources/Resources/gate-and.png"), QSize(), QIcon::Normal, QIcon::Off);
